...
// const [productData,setProductsData] =useState({ name: "",price: "",image: "",cetegory: "other"});
...
//   setProductsData({ ...productData,[event.target.name]: event.target.value})
...
//       ):[]}
//       <div>
//         <img src={single.image} alt='Product'/>
